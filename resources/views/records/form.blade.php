    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <textarea class="form-control" name="observation" rows="4" @if($action == 'show') readonly @endif>{{ $report->observation ?? old('observation') }}</textarea>
                 {!! $errors->first('observation', '<small class="help-block text-danger">:message</small>') !!}
            </div>
        </div>
    </div>
</div>
