...
<body>
    <div id="container" class="cls-container">
		...
		<div class="cls-content">
		    ...
		    <h1 class="error-code text-info">¡No disponible!</h1>
		    <p class="h4 text-uppercase text-bold">Recurso no disponible (301).</p>
		    <div class="pad-btm">
		        El recurso al que desea acceder ya no se encuentra disponible. Puedes <a href="{{ route('login') }}"><mark>iniciar sesión</mark></a> o ponerte en contacto con nosotros.
		    </div>
